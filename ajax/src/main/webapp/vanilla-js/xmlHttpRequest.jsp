...
<body>
	...
	document.searchFrm.addEventListener('submit', (e) => {
		e.preventDefault(); // 제출금지. (폼제출은 동기요청이기때문에 제출금지 처리했음)
	...
	const readyStateChangeHandler = (e) => {
		...
		case 0 : console.log('0 : uninitialized'); break; // xhr 객체생성
		case 1 : console.log('1 : loading'); break; // open 연결정
